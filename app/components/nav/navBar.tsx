...
export default function NavBar(){
  ...
  return(
    <div className={`${ isVisible ? 'opacity-100' : 'opacity-0'} z-50 absolute bottom-2 left-[50%] translate-x-[-50%] py-2 md:py-4 px-6 md:px-12 bg-zinc-300/15 backdrop-blur-xs w-full md:w-fit shadow-lg border-2 border-white/40 rounded-full transition-opacity`} onMouseOver={() => setVisibility(true)}>
      { /* inner border */}
