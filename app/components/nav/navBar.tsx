...
{ /* SVGs. Was gonna use for Nav, but maybe pixel art has more character? Maybe I will just use SVGs for background (like how Wii U had moving objects in background) */}
{/* LINKEDIN LOGO SVG
